/*
   Script d'initialisation de la BDD MySQL contenant
...
CREATE TABLE Concert (
   ...
   entree_libre BOOLEAN NOT NULL DEFAULT 0,
   FOREIGN KEY(id_artiste) REFERENCES Artiste(id_artiste),
...
VALUES  (1, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("01/07/2022", "%d/%m/%Y") , "18:00" , 0 ),
 (2, (SELECT id_scene FROM Scene WHERE nom_scene = "Le Foyer") , STR_TO_DATE("01/07/2022", "%d/%m/%Y") , "19:15" , 0 ),
 (3, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("01/07/2022", "%d/%m/%Y") , "20:15" , 0 ),
 (4, (SELECT id_scene FROM Scene WHERE nom_scene = "Le Foyer") , STR_TO_DATE("01/07/2022", "%d/%m/%Y") , "21:30" , 0 ),
 (5, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("01/07/2022", "%d/%m/%Y") , "23:00" , 0 ),
 (6, (SELECT id_scene FROM Scene WHERE nom_scene = "Le Foyer") , STR_TO_DATE("01/07/2022", "%d/%m/%Y") , "23:59" , 0 ),
 (7, (SELECT id_scene FROM Scene WHERE nom_scene = "L'Avant Scène") , STR_TO_DATE("02/07/2022", "%d/%m/%Y") , "14:00" , 1 ),
 (8, (SELECT id_scene FROM Scene WHERE nom_scene = "L'Avant Scène") , STR_TO_DATE("02/07/2022", "%d/%m/%Y") , "15:30" , 1 ),
 (9, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("02/07/2022", "%d/%m/%Y") , "18:00" , 0 ),
 (10, (SELECT id_scene FROM Scene WHERE nom_scene = "Le Foyer") , STR_TO_DATE("02/07/2022", "%d/%m/%Y") , "19:15" , 0 ),
 (11, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("02/07/2022", "%d/%m/%Y") , "20:15" , 0 ),
 (12, (SELECT id_scene FROM Scene WHERE nom_scene = "Le Foyer") , STR_TO_DATE("02/07/2022", "%d/%m/%Y") , "21:30" , 0 ),
 (13, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("02/07/2022", "%d/%m/%Y") , "22:30" , 0 ),
 (14, (SELECT id_scene FROM Scene WHERE nom_scene = "Le Foyer") , STR_TO_DATE("02/07/2022", "%d/%m/%Y") , "23:45" , 0 ),
 (15, (SELECT id_scene FROM Scene WHERE nom_scene = "L'Avant Scène") , STR_TO_DATE("03/07/2022", "%d/%m/%Y") , "12:00" , 1 ),
 (16, (SELECT id_scene FROM Scene WHERE nom_scene = "L'Avant Scène") , STR_TO_DATE("03/07/2022", "%d/%m/%Y") , "13:00" , 1 ),
 (17, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("03/07/2022", "%d/%m/%Y") , "15:00" , 0 ),
 (18, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("03/07/2022", "%d/%m/%Y") , "15:30" , 0 ),
 (19, (SELECT id_scene FROM Scene WHERE nom_scene = "Le Foyer") , STR_TO_DATE("03/07/2022", "%d/%m/%Y") , "16:00" , 0 ),
 (20, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("03/07/2022", "%d/%m/%Y") , "16:40" , 0 ),
 (21, (SELECT id_scene FROM Scene WHERE nom_scene = "Le Foyer") , STR_TO_DATE("03/07/2022", "%d/%m/%Y") , "17:30" , 0 ),
 (22, (SELECT id_scene FROM Scene WHERE nom_scene = "Le Foyer") , STR_TO_DATE("03/07/2022", "%d/%m/%Y") , "19:30" , 0 ),
 (23, (SELECT id_scene FROM Scene WHERE nom_scene = "La Terrasse") , STR_TO_DATE("03/07/2022", "%d/%m/%Y") , "21:00" , 0 );
